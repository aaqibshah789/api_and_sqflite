...
//
//     final modelPrayer = modelPrayerFromMap(jsonString);

import 'dart:convert';

ModelPrayer modelPrayerFromMap(String str) => ModelPrayer.fromMap(json.decode(str));

String modelPrayerToMap(ModelPrayer data) => json.encode(data.toMap());
...
class ModelPrayer {
    ...
    factory ModelPrayer.fromMap(Map<String, dynamic> json) => ModelPrayer(
        code: json["code"],
        status: json["status"],
